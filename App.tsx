    ...
    <div id="portfolio">
      <div className="min-h-screen bg-slate-50 dark:bg-slate-950 transition-colors duration-300 relative">
        ...
        <main className="relative z-10">
          ...
          <section id="pdf-experience">
            <Experience />
          </section>
          <section id="pdf-projects">
        ...
        <button
          onClick={scrollToTop}
          className={`fixed bottom-8 right-8 z-50 p-3 rounded-full bg-primary text-white shadow-lg shadow-teal-500/30 hover:bg-teal-600 hover:-translate-y-1 transition-all duration-300 ${showScrollTop ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10 pointer-events-none'
            }`}
